...
export default function ServiceDetailsScreen() {
    ...
    try {
      ...
      if (vendorId) {
        navigation.navigate("ChatDetailScreen", {
          ...
          vendorAvatar: service?.vendor?.vendorOnboarding?.profilePicture,
        });
      }
    } catch (error) {
  ...
  const handleSeeReviews = () => {
    ...
    try {
      ...
      const reviewsParams = {
        vendorId: service?.vendor?.id || service?.userId,
  ...
  const handleBookingNavigation = async () => {
    ...
    try {
      ...
      // Prepare minimal navigation params
      const navigationParams = {
        ...
        vendor: {
          ...
          profilePicture: service?.vendor?.vendorOnboarding?.profilePicture,
