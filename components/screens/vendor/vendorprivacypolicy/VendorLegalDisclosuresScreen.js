...
export default function VendorLegalDisclosuresScreen() {
  ...
  return (
    <View className="flex-1 bg-white pb-[50px]">
      ...
      <ScrollView className="flex-1 px-4 " showsVerticalScrollIndicator={false}>
        ...
        >
          We will, without prior notification to you, disclose any information
          we collect, use or receive if required or permitted by law, such as to
          ...
          respond to a government request. We may also disclose any information
          to protect and defend the rights or property of SharpLook, to prevent
