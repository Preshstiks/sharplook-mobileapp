...
export default function TermsOfUseIntellectualPropertyScreen() {
  ...
  return (
    <View className="flex-1 bg-white pb-[50px]">
      ...
      <ScrollView className="flex-1 px-4 " showsVerticalScrollIndicator={false}>
        ...
        >
          <Text style={{ fontFamily: "poppinsBold" }}>Ownership:</Text> All
          ...
          {"\n\n"}
          <Text style={{ fontFamily: "poppinsBold" }}>Restrictions:</Text> You
          may not reproduce, distribute, modify, create derivative works of,
          publicly display, or exploit any content without our prior written
          consent.
        </Text>
      </ScrollView>
    </View>
